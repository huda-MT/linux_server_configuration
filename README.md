...
- To connect to the instance via the terminal: `ssh -i ~/.ssh/lightsail_key.rsa ubuntu@18.194.185.210`,
  where `18.194.185.210` is the public IP address of the instance.

<!--
Public IP address is 18.194.185.210.
ssh -i ~/.ssh/lightsail_key.rsa ubuntu@18.194.185.210
-->
...
- From your local terminal, run: `ssh -i ~/.ssh/lightsail_key.rsa -p 2200 ubuntu@18.194.185.210`, where `18.194.185.210` is the public IP address of the instance.

<!--
Public IP address is 18.194.185.210.
ssh -i ~/.ssh/lightsail_key.rsa -p 2200 ubuntu@18.194.185.210
-->
...
- On the grader's virtual machine:
  ...
  - Restart SSH: `sudo service ssh restart`
- On the local machine, run: `ssh -i ~/.ssh/grader_key -p 2200 grader@18.194.185.210`.

<!--
Public IP address is 18.194.185.210.
ssh -i ~/.ssh/grader_key -p 2200 grader@18.194.185.210
...
`sudo git clone https://github.com/huda-MT/makeupCataloge`.
...
- Click `Credentials`.
- Create an OAuth Client ID (under the Credentials tab), and add http://18.194.185.210.xip.io as authorized JavaScript
origins.
- Add http://ec2-18-194-185-210.us-west-2.compute.amazonaws.com
...
### Step 14.1: Set up and enable a virtual host
(Extra)
...
following lines to configure the virtual host:
  ...
  ```
  <VirtualHost *:80>
  ServerName 18.194.185.210
  ServerAlias ec2-18-194-185-210.us-west-2.compute.amazonaws.com
  ServerAdmin admin@18.194.185.210
...
### Step 14.4: Disable the default Apache site
...
### Step 14.5: Launch the Web Application

- Change the ownership of the project directories: `sudo chown -R www-data:www-data catalog/`.
- Restart Apache again: `sudo service apache2 restart`.
- Open your browser to http://18.194.185.210.xip.io.
...
https://github.com/AliMahmoud7/linux-server-configuration
https://github.com/FahadAlsubaie/linux_server_configuration/blob/master/README.md
